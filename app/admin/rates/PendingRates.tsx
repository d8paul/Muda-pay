...
import { Search, X, CheckCircle, Loader2, Eye } from "lucide-react"
...
export default function PendingRates() {
  ...
  const { hasRequiredPermission } = usePermissions('rates.approve')
                  ...
                  >
                    ...
                    <TableCell className="text-right">
                      ...
                      <div className="text-xs text-gray-500 mb-1">
                        Role: {user?.role || 'None'} | Permission: {hasRequiredPermission ? 'Yes' : 'No'}
                      </div>

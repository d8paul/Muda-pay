...
export default function BulkTransfersPage() {
  ...
  const onDrop = useCallback(
    (acceptedFiles: File[]) => {
      ...
      setTimeout(() => {
        router.push("/dashboard/bulk-transfers/confirm")
      }, 1000)
    },
    [router],
  )
  ...
  return (
    <div className="py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <h1 className="text-2xl font-semibold text-gray-900">Bulk Transfers</h1>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="py-4">
          <div className="bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900">Upload Bulk Transfer File</h3>
              <div className="mt-2 max-w-xl text-sm text-gray-500">
                <p>Upload a CSV file containing the bulk transfer details.</p>
              </div>
              <div
                {...getRootProps()}
